...
def rand_palavra():
    ...
    palavras = ['alien', 'amelie', 'arrival', 'avatar', 'bambi', 'braveheart', 'casablanca', 'coco', 'dumbo', 'fargo', 'fantasia', 'frozen', 'gladiator', 'gravity', 'hereditary', 'hugo', 'interstellar', 'jumanji', 'matilda', 'memento', 'moana', 'mulam', 'psycho', 'scream', 'shrek', 'tangled', 'us', 'vertigo', 'whiplash', 'zootopia']
